...
if ( ! class_exists( 'AffiliateWP_Sign_Up_Bonus' ) ) {
	...
	/**
	 * Main AffiliateWP_Sign_Up_Bonus class.
	 *
	 * @since 1.0
	 */
	final class AffiliateWP_Sign_Up_Bonus {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'affiliatewp-sign-up-bonus' ), '1.1' );
		}
		 ...
		 * @param int $sign_up_bonus Sign up bonus.
		 */
		 ...
		 *
		 * @param int    $affiliate_id Affiliate ID.
		 * @param string $status       The new affiliate status.
		...
		public function new_affiliate_options() {
			...
			<tr class="form-row">
				...
				<th scope="row">
					<label for="has_sign_up_bonus"><?php esc_html_e( 'Sign Up Bonus', 'affiliatewp-sign-up-bonus' ); ?></label>
				</th>

				<td>
					<input type="checkbox" name="has_sign_up_bonus" id="has_sign_up_bonus" value="1" <?php checked( 1, 1 ); ?> />
					<p class="description"><?php esc_html_e( 'Award sign up bonus?', 'affiliatewp-sign-up-bonus' ); ?></p>
				</td>
			...
			<tr class="form-row">
				...
				<th scope="row">
					<label for="sign_up_bonus"><?php esc_html_e( 'Sign Up Bonus Amount', 'affiliatewp-sign-up-bonus' ); ?></label>
				</th>

				<td>
					<input class="regular-text" type="text" name="sign_up_bonus" id="sign_up_bonus" value="<?php echo esc_attr( affiliate_wp()->settings->get( 'sign_up_bonus' ) ); ?>" />
					<p class="description"><?php esc_html_e( 'How much should this affiliate be awarded as a sign up bonus? Leaving blank will default to the global amount', 'affiliatewp-sign-up-bonus' ); ?></p>
				</td>
		 ...
		 * @since 1.0
		 *
		 * @param array $settings The enabled integrations.
		 */
